...
const resources = {
  vi: {
    translation: {
      ...
      no_scores_yet: "Chưa có điểm số nào trên bảng xếp hạng.",
      anonymous_player: "Người chơi",
      leaderboard_rank: "Hạng {{rank}}",
  ...
  en: {
    translation: {
      ...
      no_scores_yet: "There are no scores on the leaderboard yet.",
      anonymous_player: "Player",
